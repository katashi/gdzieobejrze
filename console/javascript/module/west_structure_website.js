...
function West_Structure_Website() {
    ...
    this.init = function() {
        ...
        var config = new Object({
            ...
            dataUrl: base_url+'/_core:tree/tree_create/structure_website',
    ...
    this.directory_add = function() {
        new Helper_Ui().add_window('structure_website_directory_add', 'Dodaj Katalog', base_url +'/_core:tree/add/structure_website,1');
    }
